...
namespace Accord.Neuro.Networks {
    ...
    /// 
    [Serializable]
    public class DBN : DeepBeliefNetwork {
        ...
        /// 
        public DBN(int inputsCount, params int[] hiddenNeurons)
        ...
        /// <param name="hiddenNeurons">The number of hidden neurons in each layer.</param>
        /// 
        public DBN(IStochasticFunction function, int inputsCount, params int[] hiddenNeurons)
        ...
        /// 
        public DBN(int inputsCount, params RestrictedBoltzmannMachine[] layers)
